...
--
-- Värd: localhost
-- Tid vid skapande: 09 okt 2017 kl 08:55
...
--
-- Ersättningsstruktur för vy `ALL_PLUGINS`
...
--
-- Ersättningsstruktur för vy `APPLICABLE_ROLES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `CHANGED_PAGE_BITMAPS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `CHARACTER_SETS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `CLIENT_STATISTICS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `COLLATIONS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `COLLATION_CHARACTER_SET_APPLICABILITY`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `COLUMNS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `COLUMN_PRIVILEGES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `ENABLED_ROLES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `ENGINES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `EVENTS`
-- (See below for the actual view)
--
CREATE TABLE `EVENTS` (
...
--
-- Ersättningsstruktur för vy `FILES`
-- (See below for the actual view)
--
CREATE TABLE `FILES` (
`FILE_ID` bigint(4)
...
--
-- Ersättningsstruktur för vy `GEOMETRY_COLUMNS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `GLOBAL_STATUS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `GLOBAL_VARIABLES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INDEX_STATISTICS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_BUFFER_PAGE`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_BUFFER_PAGE_LRU`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_BUFFER_POOL_STATS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_CHANGED_PAGES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_CMP`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_CMPMEM`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_CMPMEM_RESET`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_CMP_PER_INDEX`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_CMP_PER_INDEX_RESET`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_CMP_RESET`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_FT_BEING_DELETED`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_FT_CONFIG`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_FT_DEFAULT_STOPWORD`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_FT_DELETED`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_FT_INDEX_CACHE`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_FT_INDEX_TABLE`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_LOCKS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_LOCK_WAITS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_METRICS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_MUTEXES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_COLUMNS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_DATAFILES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_FIELDS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_FOREIGN`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_FOREIGN_COLS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_INDEXES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_SEMAPHORE_WAITS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_TABLES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_TABLESPACES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_SYS_TABLESTATS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_TABLESPACES_ENCRYPTION`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_TABLESPACES_SCRUBBING`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `INNODB_TRX`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `KEY_CACHES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `KEY_COLUMN_USAGE`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `PARAMETERS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `PARTITIONS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `PLUGINS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `PROCESSLIST`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `PROFILING`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `REFERENTIAL_CONSTRAINTS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `ROUTINES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `SCHEMATA`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `SCHEMA_PRIVILEGES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `SESSION_STATUS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `SESSION_VARIABLES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `SPATIAL_REF_SYS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `STATISTICS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `SYSTEM_VARIABLES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `TABLES`
-- (See below for the actual view)
--
CREATE TABLE `TABLES` (
`TABLE_CATALOG` varchar(512)
...
--
-- Ersättningsstruktur för vy `TABLESPACES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `TABLE_CONSTRAINTS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `TABLE_PRIVILEGES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `TABLE_STATISTICS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `TRIGGERS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `USER_PRIVILEGES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `USER_STATISTICS`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `VIEWS`
-- (See below for the actual view)
--
CREATE TABLE `VIEWS` (
`TABLE_CATALOG` varchar(512)
...
--
-- Ersättningsstruktur för vy `XTRADB_INTERNAL_HASH_TABLES`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `XTRADB_READ_VIEW`
-- (See below for the actual view)
--
...
--
-- Ersättningsstruktur för vy `XTRADB_RSEG`
-- (See below for the actual view)
--
...
--
-- Struktur för vy `APPLICABLE_ROLES`
--
...
--
-- Struktur för vy `CHANGED_PAGE_BITMAPS`
--
...
--
-- Struktur för vy `CHARACTER_SETS`
--
...
--
-- Struktur för vy `CLIENT_STATISTICS`
--
...
--
-- Struktur för vy `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- Struktur för vy `COLUMN_PRIVILEGES`
--
...
--
-- Struktur för vy `GEOMETRY_COLUMNS`
--
...
--
-- Struktur för vy `GLOBAL_VARIABLES`
--
...
--
-- Struktur för vy `INDEX_STATISTICS`
--
...
--
-- Struktur för vy `INNODB_BUFFER_PAGE`
--
...
--
-- Struktur för vy `INNODB_BUFFER_PAGE_LRU`
--
...
--
-- Struktur för vy `INNODB_BUFFER_POOL_STATS`
--
...
--
-- Struktur för vy `INNODB_CHANGED_PAGES`
--
...
--
-- Struktur för vy `INNODB_CMPMEM_RESET`
--
...
--
-- Struktur för vy `INNODB_CMP_PER_INDEX`
--
...
--
-- Struktur för vy `INNODB_CMP_PER_INDEX_RESET`
--
...
--
-- Struktur för vy `INNODB_CMP_RESET`
--
...
--
-- Struktur för vy `INNODB_FT_BEING_DELETED`
--
...
--
-- Struktur för vy `INNODB_FT_CONFIG`
--
...
--
-- Struktur för vy `INNODB_FT_DEFAULT_STOPWORD`
--
...
--
-- Struktur för vy `INNODB_FT_DELETED`
--
...
--
-- Struktur för vy `INNODB_FT_INDEX_CACHE`
--
...
--
-- Struktur för vy `INNODB_FT_INDEX_TABLE`
--
...
--
-- Struktur för vy `INNODB_LOCK_WAITS`
--
...
--
-- Struktur för vy `INNODB_METRICS`
--
...
--
-- Struktur för vy `INNODB_MUTEXES`
--
...
--
-- Struktur för vy `INNODB_SYS_COLUMNS`
--
...
--
-- Struktur för vy `INNODB_SYS_DATAFILES`
--
...
--
-- Struktur för vy `INNODB_SYS_FIELDS`
--
...
--
-- Struktur för vy `INNODB_SYS_FOREIGN`
--
...
--
-- Struktur för vy `INNODB_SYS_FOREIGN_COLS`
--
...
--
-- Struktur för vy `INNODB_SYS_INDEXES`
--
...
--
-- Struktur för vy `INNODB_SYS_SEMAPHORE_WAITS`
--
...
--
-- Struktur för vy `INNODB_SYS_TABLES`
--
...
--
-- Struktur för vy `INNODB_SYS_TABLESPACES`
--
...
--
-- Struktur för vy `INNODB_SYS_TABLESTATS`
--
...
--
-- Struktur för vy `INNODB_TABLESPACES_ENCRYPTION`
--
...
--
-- Struktur för vy `INNODB_TABLESPACES_SCRUBBING`
--
...
--
-- Struktur för vy `KEY_COLUMN_USAGE`
--
...
--
-- Struktur för vy `REFERENTIAL_CONSTRAINTS`
--
...
--
-- Struktur för vy `SCHEMA_PRIVILEGES`
--
...
--
-- Struktur för vy `SESSION_STATUS`
--
...
--
-- Struktur för vy `SESSION_VARIABLES`
--
...
--
-- Struktur för vy `SPATIAL_REF_SYS`
--
...
--
-- Struktur för vy `SYSTEM_VARIABLES`
--
...
--
-- Struktur för vy `TABLE_CONSTRAINTS`
--
...
--
-- Struktur för vy `TABLE_PRIVILEGES`
--
...
--
-- Struktur för vy `TABLE_STATISTICS`
--
...
--
-- Struktur för vy `USER_PRIVILEGES`
--
...
--
-- Struktur för vy `USER_STATISTICS`
--
...
--
-- Struktur för vy `XTRADB_INTERNAL_HASH_TABLES`
--
...
--
-- Struktur för vy `XTRADB_READ_VIEW`
--
